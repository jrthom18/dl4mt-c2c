...
def main(job_id, args):
    ...
    source_dictionary = args.data_path + "train.source.1004.pkl"
    target_dictionary = args.data_path + "train.target.1002.pkl"
...
if __name__ == '__main__':
    ...
    parser.add_argument('-sampleFreq', type=int, default=2500, help="")
    parser.add_argument('-dispFreq', type=int, default=500, help="")
